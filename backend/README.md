...
## Project Structure
    ...
    ├── testapiautoconnecto_75995  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_75995`
...
2. Clone this repo and `cd testapiautoconnecto_75995`
